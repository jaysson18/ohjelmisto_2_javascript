...
document.addEventListener("DOMContentLoaded", function() {
  const picArray = [
    ...
    const articlesSection = document.getElementById("pictures"); // Corrected the ID
    ...
    for (let i = 0; i < picArray.length; i++) {
        ...
        imageElement.src = picArray[i].image.medium; // Corrected the path
        ...
        paragraphElement.textContent = picArray[i].description;
